...
module.exports = {
    ...
    Types: {
                ...
                Default: {
                    ...
                    Types: {
                        ...
                        FurtherTesting: {
                            ...
                            PromWordSpiel: 'Our network engineers are conducting further testing and diagnosis for your repair ticket.\n\nTo track the status of your ticket, please visit https://pldthome.com/pldt-tracker or text PLDTTRACK to 8171 for Smart and TNT for free; or 0970 0000 171 for other networks. Thank you.',
                        },
                        Resolved: {
                            Validation: /(FM_POLL)/g,
                            PromWordSpiel: 'Your repair ticket has been resolved and service has been restored. For internet-related issue, please turn your modem OFF then ON after 5 minutes to refresh your connection. Please visit www.pldthome.com/support should you need assistance with your service. Thank you.',
                        },
                        Deafult: {
        ...
        WithOpenSO: { Message: 'With Open SO.', Conversation: { Transition: 'openso', Variables: ['ineligibleAcctmsg', 'openSONumber'] }},
        ...
        AccountIsNotRBG: { Message: 'Account is not RBG.', Conversation: { Transition: 'notRBG', Variables: ['ineligibleAcctmsg'] }},
