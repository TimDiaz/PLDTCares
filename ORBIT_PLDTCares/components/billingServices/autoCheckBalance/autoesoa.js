...
module.exports = {
    ...
    invoke: (conversation, done) => {
        ...
        const _logger = instance.logger(globalProp.Logger.Category.Autoesoa);
        ...
        function logError(result, resultCode){
            ...
            const message = globalProp.Email.EmailFormat(globalProp.Autobal.API.GetEsoaBalance, resultCode, strResult, serviceNumber);
        ...
        emailLog.addContext("subject", globalProp.Email.Subjects.Autoesoa);
        emailLog.addContext("apiUrl", globalProp.Logger.BCPLogging.URL);
        emailLog.addContext("apiname", globalProp.Logger.BCPLogging.AppNames.Autobal.Autoesoa);
        ...
        var options = globalProp.Autoesoa.API.GetEsoaBalance.GetOptions(svcNum, numMon);
